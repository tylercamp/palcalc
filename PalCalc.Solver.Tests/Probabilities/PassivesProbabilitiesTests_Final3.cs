    ...
    public class PassivesProbabilitiesTests_Final3 : PassivesProbabilitiesTestBase
    {
        ...
        public void Parents_None__Desired_None()
        {
            Assert.AreEqual(
                ...
                expected: mechanics.PassiveRandomAddedProbability[3],
        ...
        public void Parents_1__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 3, inherit 0
                    (mechanics.PassiveRandomAddedProbability[3] * PassiveProbabilityDirectUpTo(numAvailable: 1, numRequired: 0)) +

                    // random 2, inherit 1
                    (mechanics.PassiveRandomAddedProbability[2] * PassiveProbabilityDirectUpTo(numAvailable: 1, numRequired: 1))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_2__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 3, inherit 0
                    (mechanics.PassiveRandomAddedProbability[3] * PassiveProbabilityDirectUpTo(numAvailable: 2, numRequired: 0)) +

                    // random 2, inherit 1
                    (mechanics.PassiveRandomAddedProbability[2] * PassiveProbabilityDirectUpTo(numAvailable: 2, numRequired: 1)) +

                    // random 1, inherit 2
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 2, numRequired: 2))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_3__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 3, inherit 0
                    (mechanics.PassiveRandomAddedProbability[3] * PassiveProbabilityDirectUpTo(numAvailable: 3, numRequired: 0)) +

                    // random 2, inherit 1
                    (mechanics.PassiveRandomAddedProbability[2] * PassiveProbabilityDirectUpTo(numAvailable: 3, numRequired: 1)) +

                    // random 1, inherit 2
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 3, numRequired: 2)) +

                    // random 0, inherit 3
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 3, numRequired: 3))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_4__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 3, inherit 0
                    (mechanics.PassiveRandomAddedProbability[3] * PassiveProbabilityDirectUpTo(numAvailable: 4, numRequired: 0)) +

                    // random 2, inherit 1
                    (mechanics.PassiveRandomAddedProbability[2] * PassiveProbabilityDirectUpTo(numAvailable: 4, numRequired: 1)) +

                    // random 1, inherit 2
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 4, numRequired: 2)) +

                    // random 0, inherit 3
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 4, numRequired: 3))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_5__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 3, inherit 0
                    (mechanics.PassiveRandomAddedProbability[3] * PassiveProbabilityDirectUpTo(numAvailable: 5, numRequired: 0)) +

                    // random 2, inherit 1
                    (mechanics.PassiveRandomAddedProbability[2] * PassiveProbabilityDirectUpTo(numAvailable: 5, numRequired: 1)) +

                    // random 1, inherit 2
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 5, numRequired: 2)) +

                    // random 0, inherit 3
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 5, numRequired: 3))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
