    ...
    public class PassivesProbabilitiesTests_Final1 : PassivesProbabilitiesTestBase
    {
        ...
        public void Parents_None__Desired_None()
        {
            Assert.AreEqual(
                ...
                expected: mechanics.PassiveRandomAddedProbability[1],
        ...
        public void Parents_1__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 1, inherit 0
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 1, numRequired: 0)) +

                    // random 0, inherit 1
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 1, numRequired: 1))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_2__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 0, inherit 1
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 2, numRequired: 1)) +
                    // random 1, inherit 0
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 2, numRequired: 0))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_3__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 0, inherit 1
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 3, numRequired: 1)) +
                    // random 1, inherit 0
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 3, numRequired: 0))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_4__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 0, inherit 1
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 4, numRequired: 1)) +
                    // random 1, inherit 0
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 4, numRequired: 0))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
        ...
        public void Parents_5__Desired_None()
        {
            Assert.AreEqual(
                expected: (
                    // random 0, inherit 1
                    (mechanics.PassiveRandomAddedProbability[0] * PassiveProbabilityDirectUpTo(numAvailable: 5, numRequired: 1)) +
                    // random 1, inherit 0
                    (mechanics.PassiveRandomAddedProbability[1] * PassiveProbabilityDirectUpTo(numAvailable: 5, numRequired: 0))
                ),
                actual: PassiveProbabilities.ProbabilityInheritedTargetPassives(mechanics,
