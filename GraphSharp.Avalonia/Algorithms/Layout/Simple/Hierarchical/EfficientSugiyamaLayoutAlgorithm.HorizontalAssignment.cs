        ...
        private void DoOrthogonalEdgeRouting()
        {
            foreach (var edge in VisitedGraph.Edges)
            {
                ...
                orthoRoutePoints[sourceIndex] = new Point(
                    sourceVertex.HorizontalPosition,
                    _layerPositions[sourceVertex.LayerIndex] + _layerHeights[sourceVertex.LayerIndex] + Parameters.LayerDistance / 2.0
                );
                orthoRoutePoints[targetIndex] = new Point(
                    targetVertex.HorizontalPosition,
