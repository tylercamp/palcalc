        ...
        where TGraph : IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        private class CompoundVertexData : VertexData
        {
            ...
            public void RecalculateBounds()
            {
                ...
                {
                    topLeft = new Point(
                        Math.Min(topLeft.X, child.Position.X - child.Size.Width / 2),
                        Math.Min(topLeft.Y, child.Position.Y - child.Size.Height / 2)
                    );

                    bottomRight = new Point(
                        Math.Max(bottomRight.X, child.Position.X + child.Size.Width / 2),
                        Math.Max(bottomRight.Y, child.Position.Y + child.Size.Height / 2)
                    );
                }
