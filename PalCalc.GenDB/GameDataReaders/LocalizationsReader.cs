...
{
    class LocalizationInfo(string languageCode, string palNameTextPath, string skillNameTextPath)
    {
    ...
    internal class LocalizationsReader
    {
        public static List<LocalizationInfo> FetchLocalizations(IFileProvider provider)
        {
            ...
            foreach (var lang in langs)
            {
                ...
                res.Add(new LocalizationInfo(lang, $"{basePath}/DT_PalNameText", $"{basePath}/DT_SkillNameText"));
            }

            res.Add(new LocalizationInfo("ja", "Pal/Content/Pal/DataTable/Text/DT_PalNameText", "Pal/Content/Pal/DataTable/Text/DT_SkillNameText"));
            return res;
        }
    }
}
