...
**CRITICAL DIRECTIVE: MANDATORY CONTEXT UPDATES**

Whenever I obtain, discover, analyze, or document new knowledge about the project, I MUST immediately update `context.md` to reflect:
1. What knowledge was obtained/discovered
2. What files were updated with this knowledge
3. The current focus/status

This applies to ALL knowledge acquisition activities including:
- Code analysis and scanning
- System investigation
- Documentation research
- Feature exploration
- Architecture analysis
- Any form of project discovery

**I must update context.md BEFORE attempting completion of any knowledge-gathering task.**
